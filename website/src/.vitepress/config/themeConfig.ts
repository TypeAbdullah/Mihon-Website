...
const themeConfig: DefaultTheme.Config = {
  ...
  socialLinks: [
    {
      icon: 'github',
      link: 'https://github.com/TypeAbdullah',
    ...
    {
      icon: {
        <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Telegram</title><path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.17.91-.494 1.208-.822 1.23-.696.045-1.225-.432-1.865-.848l-2.556-1.88-1.23 1.18c-.136.136-.25.25-.4.4-.149.149-.292.292-.43.43-.16.16-.336.336-.516.516a.91.91 0 0 1-.22.146c-.16.09-.374.12-.534.12-.262 0-.44-.09-.534-.27-.12-.24-.18-.48-.18-.72l.006-2.772 4.793-4.323c.21-.18.39-.33.15-.57-.21-.21-.48-.15-.72-.09l-5.937 3.732a1.73 1.73 0 0 1-1.474-.782c-.015-.03-.03-.06-.045-.09-.39-1.08.195-1.6 1.08-2.05z"/></svg>,
      },
      link: 'https://t.me/',
      ariaLabel: 'Telegram'
